...
import CardExample from "./cards";
    ...
    return (
        ...
        <div className="bg-[url('/Graphic_Side_bg.svg')] text-white mt-16 h-36 rounded-lg p-4">
            <div className="flex justify-between text-center items-center">
                <Typography variant="h5">
                    Hello
                </Typography>
                <button className="bg-blue-500 text-white mt-4 opacity-90 p-2 flex items-center space-x-2 mr-3">
                    ...
                    <span className="opacity-90">Announcement</span>
                </button>
        </div>
